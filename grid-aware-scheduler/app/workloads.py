...
.hero{background:linear-gradient(160deg,color-mix(in srgb,var(--blue) 9%,var(--card)),var(--card) 62%);border:1px solid var(--sep);border-radius:20px;padding:26px 28px 22px;margin-bottom:20px;box-shadow:var(--shadow)}
.hero-top{display:flex;gap:26px;align-items:flex-start;justify-content:space-between;flex-wrap:wrap;margin-bottom:20px}
.hero h2{margin:2px 0 6px;font-size:27px;letter-spacing:-0.02em;line-height:1.15}
.hero-sub{margin:0;max-width:46ch;color:var(--text-2);font-size:13px;line-height:1.55}
.hero-signal{display:flex;gap:26px;flex-wrap:wrap}
.hero-stat{min-width:96px}
.hero-stat span{display:block;font-size:10px;text-transform:uppercase;letter-spacing:.055em;color:var(--text-3);margin-bottom:3px}
.hero-stat b{font-size:17px;font-weight:640;letter-spacing:-0.01em;font-variant-numeric:tabular-nums}
...
<nav><a class="on" href="/?__SHARED__">Operations</a><a href="/simulator?__SHARED__">Fleet Lab</a><a href="/planner?__SHARED__">Placement Lab</a><a href="/grid?__SHARED__">Sites &amp; Grid</a><a href="/site">Site</a><a href="/decisions">Decisions</a></nav></header>
<section class="hero" id="hero"><div class="hero-top"><div><span class="eyebrow">Your compute, right now</span><h2 id="heroTitle">Reading this facility…</h2><p class="hero-sub" id="heroSub">Identifying every reachable device, what it can do, and what electricity currently costs.</p></div><div class="hero-signal"><div class="hero-stat"><span>Electricity</span><b>__CURRENT_PRICE__</b></div><div class="hero-stat"><span>Carbon</span><b>__CURRENT_CARBON__</b></div><div class="hero-stat"><span>Cheapest ahead</span><b>__LOW_PRICE__</b></div><div class="hero-stat"><span>Cleanest ahead</span><b>__CLEAN_CARBON__</b></div></div></div>
<div class="hero-devices" id="heroDevices"></div>
<p class="hero-note" id="heroNote">Every figure below carries the source it came from. <b>MEASURED</b> was reproduced on this hardware, <b>PUBLISHED</b> was measured by an audited third party, <b>SPEC</b> and <b>ESTIMATED</b> are not measurements at all.</p></section>
